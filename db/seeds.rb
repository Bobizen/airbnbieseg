...
# seed for flats
flat1 = Flat.create(user_id: 1, street_address: "25 Rue du Faubourg Saint-Antoine", city: "Paris", country: "France", zipcode: "75011", title: "Beautiful place to spend some days in Paris", price_per_night: 250, free_cancellation: false, homepagetitle: "Merlimont, France", address: "25 Rue du Faubourg Saint-Antoine, Paris", latitude:Faker::Address.latitude, longitude:Faker::Address.longitude)
...
flat2 = Flat.create(user_id: 1, street_address: "8 Rue de la République", city: "Lyon", country: "France", zipcode: "69001", title: "Small appartment in the center of Paris", price_per_night: 150, free_cancellation: false, homepagetitle: "Eiffle, France", address: "25 Rue du Faubourg Saint-Antoine, Paris",latitude:Faker::Address.latitude, longitude:Faker::Address.longitude)
...
flat3 = Flat.create(user_id: 2, city: "Strasbourg", street_address:"12 Rue des Bouchers", country: "France", zipcode: "67000", title: "Big house for group close to La Défense", price_per_night: 399.99, free_cancellation: true, homepagetitle: "Roxy's House, France", address: "12 Rue des Bouchers, Strasbourg",latitude:Faker::Address.latitude, longitude:Faker::Address.longitude)
...
flat4 = Flat.create(user_id: 2, city: "Paris", street_address:"5 Avenue des Champs-Élysées",country: "France", zipcode: "75008", title: "Amazing appartment with view on the Eiffel Tower", price_per_night: 500, free_cancellation: false, homepagetitle: "Oliver's penthouse, France", address: "5 Avenue des Champs-Élysées, Paris",latitude:Faker::Address.latitude, longitude:Faker::Address.longitude)
